        ...
        content: fields.document({
          ...
          componentBlocks: {
            alert: component({
              ...
              preview: (props) => {
                return (
                  <div style={{ padding: '10px', background: props.fields.type.value === 'danger' ? '#fee' : '#eef', border: '1px solid currentColor', borderRadius: '4px' }}>
                    <strong>{props.fields.type.value === 'danger' ? 'PELIGRO:' : 'NOTA:'}</strong> {props.fields.message.value}
                  </div>
                )
              }
            }),
